...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Data Pelaporan</h3>
            ...
            <div class="container-fluid">
                ...
                if (isset($_GET['pesan'])) {
                    ...
                    if ($pesan == "input") {
                        ...
                        echo
                        '<div class="alert alert-success" role="alert"> Data berhasil di terima! silahkan cek pada Tabel Bencana!</div';
                    } else if ($pesan == "acc!") {
                        echo
                        '<div class="alert alert-success" role="alert"> Data gagal di terima!</div';
                    }
                }
                ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="table_id" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    JOIN bencana_detail ON rekap_bencana.id_bencana_detail = bencana_detail.id_bencana_detail WHERE status = '0'  LIMIT $mulai, $halaman ");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <!-- <a class="edit" href="editKejadian.php?id=<?php echo $row['id_rekap']; ?>">Edit</a> | -->
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $row['id_rekap']; ?>">Hapus</a>
                                            </td>
                                        </tr>
                                </tbody>
                            <?php } ?>
        ...
        <div class="modal fade" id="modal<?php echo $row['id_rekap']; ?>" tabindex="-1" aria-labelledby="statusLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="aksi_validasi.php" method="post">
    ...
    <?php } ?>
    <?php foreach ($sql as $key => $row) { ?>
        <div class="modal fade" id="hapus<?php echo $row['id_rekap']; ?>" tabindex="-1" aria-labelledby="statusLabel" aria-hidden="true">
            <div class="modal-dialog modal-ms modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="delete/del_bencana.php?id=<?php echo $row['id_rekap']; ?>">Yes</a>
                    </div>
                </div>
            </div>
        </div>
